...
## wget -O /root/csf_sucuri_allow.sh https://gitlab.com/mikeramsey/apache-htaccess-rules/raw/master/Sucuri/csf_sucuri_allow.sh
## chmod +x /root/csf_sucuri_allow.sh
# /root/csf_sucuri_allow.sh 
# sh csf_cf_allow.sh
# Cron Example:
...
#Regex to parse unique IPv4/IPv6 Cidr ranges for Sucuri /etc/csf/sucuri.allow
